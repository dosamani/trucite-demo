export default function About() {
  return (
    <main style={{maxWidth:800,margin:"0 auto",padding:"40px 20px",textAlign:"center",color:"#e9e9ea"}}>
      <h1 style={{fontSize:"clamp(28px,5vw,42px)",fontWeight:700,color:"#f2c94c",marginBottom:16}}>
        About TruCite
      </h1>
